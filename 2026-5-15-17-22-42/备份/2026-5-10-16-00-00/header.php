      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="<?php echo checkIfActive('nav')?>"><a href="./nav/"><i class="fa fa-compass" aria-hidden="true"></i> 功能导航</a></li>
            <?php if($is_file){?>
            ...
            <?php if($conf['userlogin']){?>
              ...
              <li class="dropdown">
                <a data-target="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo htmlspecialchars($userrow['avatar'])?>" style="width:20px;height:20px;border-radius:50%;margin-right:5px;vertical-align:middle;">
                  <?php }else{?>
                  <i class="fa fa-<?php echo $userrow['type']=='qq'?'qq':'user';?>" aria-hidden="true"></i>
                  <?php }?>
                  <?php echo $userrow['nickname']?><b class="caret"></b>
                </a>
                <ul class="dropdown-menu">
                  <li><a href="./user_center.php"><i class="fa fa-user" aria-hidden="true"></i> 用户中心</a></li>
                  <li class="divider"></li>
